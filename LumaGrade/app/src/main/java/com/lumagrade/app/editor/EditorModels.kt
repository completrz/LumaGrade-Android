...
enum class PixelStretchDirection {
    Horizontal,
    Vertical,
}
...
data class Adjustments(
    ...
    val pixelStretch: Float = 0f,
    val pixelStretchPosition: Float = 0.5f,
    val pixelStretchBand: Float = 0.06f,
    val pixelStretchDirection: PixelStretchDirection = PixelStretchDirection.Horizontal,
