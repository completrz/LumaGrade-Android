...
object PresetImporter {
    ...
    private fun adjustmentsFromJson(json: JSONObject): Adjustments = Adjustments(
        ...
        pixelStretch = json.float("pixelStretch", 0f..1f),
        pixelStretchPosition = json.float("pixelStretchPosition", 0f..1f, 0.5f),
        pixelStretchBand = json.float("pixelStretchBand", 0.01f..0.30f, 0.06f),
        pixelStretchDirection = if (json.optString("pixelStretchDirection").equals("vertical", ignoreCase = true)) {
            PixelStretchDirection.Vertical
        } else {
            PixelStretchDirection.Horizontal
        },
...
object ImportedPresetStore {
    ...
    private fun adjustmentsToJson(value: Adjustments): JSONObject = JSONObject().apply {
        ...
        put("pixelStretch", value.pixelStretch)
        put("pixelStretchPosition", value.pixelStretchPosition)
        put("pixelStretchBand", value.pixelStretchBand)
        put("pixelStretchDirection", value.pixelStretchDirection.name.lowercase())
    ...
    private fun adjustmentsFromStoredJson(json: JSONObject): Adjustments = Adjustments(
        ...
        pixelStretch = json.optDouble("pixelStretch").toFloat().coerceIn(0f, 1f),
        pixelStretchPosition = json.optDouble("pixelStretchPosition", 0.5).toFloat().coerceIn(0f, 1f),
        pixelStretchBand = json.optDouble("pixelStretchBand", 0.06).toFloat().coerceIn(0.01f, 0.30f),
        pixelStretchDirection = if (json.optString("pixelStretchDirection").equals("vertical", ignoreCase = true)) {
            PixelStretchDirection.Vertical
        } else {
            PixelStretchDirection.Horizontal
